...
class Territory:
    # A 'territory_map' splits the board into stones, territory, and neutral points
...
# Map a bord into territory and dame
# Any points that are completely surrounded by a single color are counted as territory;
# makes no attempt to identify trivially dead groups
    ...
    for r in range(1, board.num_rows + 1):
        for c in range(1, board.num_cols + 1):
            ...
            if stone is not None:
                ...
                # If a point is compeletely surrounded by black or white stones,
                ...
                if len(neighbors) == 1:
                    ...
                    # Otherwise, the point has to be a neutral point, so add it to dame
                    fill_with = 'dame'
                for pos in group:
